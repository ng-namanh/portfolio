...
function Card(props: Props) {
  ...
  return (
    <CardContainer className='inter-var w-full'>
      <CardBody className='bg-gray-50 w-full md:w-[90%] relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] h-auto md:h-[460px] rounded-xl p-6 border  '>
